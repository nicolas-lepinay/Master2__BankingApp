...
class PerspectiveListView extends StatefulWidget {
  const PerspectiveListView({
    ...
    this.minScale = 0.5, // Nouveau paramètre pour l'échelle minimale
    this.initialIndex = 0,
  ...
  final double minScale; // Échelle minimale des items arrière
                ...
                child: DecoratedBox(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        widget.backItemsShadowColor.withValues(alpha: 0.8),

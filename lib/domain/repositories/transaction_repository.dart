...
abstract class TransactionRepository {
  ...
  Future<List<TransactionWithBalance>> getTransactionsWithBalance(int accountId);
  ...
  Future<List<TransactionWithBalance>> getTransactionsAroundToday(int accountId);
